...
<div class="pd-10">
    ...
    <p>
      <ul>
        <li>App Name : MikroTik Hotspot Monitor</li>
        <li>Author : <a style="text-decoration: underline;" href="#" target="_blank">vitech612</a></li>
        <li>Licence : <a href="#">MIT</a></li>
        <li>Website : <a style="text-decoration: underline;" href="https://www.vi-tech612.com/" target="_blank">https://www.vi-tech612.com/</a></li>
      </ul>
    </p>
    <p><h3>lib :</h3>
      <ul>
    ...
    <p>
      Aplikasi ini di adopsi dari mikhmon buatan kang Laksamadi Guko.Terimakasih buat beliau
    </p>
    <div>
        <i>Copyright &copy; 2023 -'.date("Y").' vitech612</i>
    </div>
</div>    
    ';
